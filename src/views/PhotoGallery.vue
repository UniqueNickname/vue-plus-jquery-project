...
export default {
  ...
  mounted () {
    this.$nextTick(() => {
      $('.photo-gallery .preview-list-item img')
        .each(function () {
      ...
      $('.photo-gallery .preview-list a:first')
        .click()
    })
  }
}
